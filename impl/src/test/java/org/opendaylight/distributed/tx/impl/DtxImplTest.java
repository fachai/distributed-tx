...
public class DtxImplTest{
    ...
    public void testPutAndRollbackOnFailureRollbackSucceed() throws InterruptedException {
        ...
        Thread.sleep(50); // the main Thread must be halted for enough time until the rollback finish
        Assert.assertTrue(f2.isDone());
        ...
        System.out.println("the size of n0's data in transaction1 is " + internalDtxTestTransaction1.getTxDataSize(n0));
    ...
    public void testPutAndRollbackOnFailureRollbackFail() throws InterruptedException {
        ...
        //the exception type check should be changed, because both rollback succeed and rollback fail have the same ReadFailException
...
//        Assert.assertEquals("Size of the identifier n0's data in transaction2 is wrong", 0, internalDtxTestTransaction2.getTxDataSize(n0));
    ...
    public void testDeleteAndRollbackOnFailure() throws InterruptedException {
        ...
        Assert.assertEquals("Size of identifier n0's data in n1 is wrong", 0, internalDtxTestTransaction1.getTxDataSize(n0));
...
//        Assert.assertEquals("Size of data in 2 is wrong", 1, internalDtxTestTransaction2.getTxDataSize(n0));
        ...
        Assert.assertEquals("Size of data in n1 is wrong", 0, internalDtxTestTransaction1.getTxDataSize(n0));
        Assert.assertEquals("Size of data in n2 is wrong", 0, internalDtxTestTransaction2.getTxDataSize(n0));
...
//       CheckedFuture<Void, TransactionCommitFailedException> f = this.dtxImpl.submit();
    ...
    public void testSubmitCreateRollbackTxFail() throws InterruptedException {
        ...
        try{
            ...
            Assert.assertTrue("", e instanceof TransactionCommitFailedException);
        }
